...
import com.example.onlinealisveris.Domain.ReviewDomain;
import com.example.onlinealisveris.databinding.ViewholderReviewBinding;
...
public class ReviewAdapter extends RecyclerView.Adapter<ReviewAdapter.Viewholder> {
    ...
    public ReviewAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ViewholderReviewBinding binding = ViewholderReviewBinding.inflate(LayoutInflater.from(context),parent,
                false);
