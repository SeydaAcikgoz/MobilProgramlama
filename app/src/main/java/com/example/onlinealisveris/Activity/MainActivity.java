...
import com.example.onlinealisveris.Adapter.CategoryAdapter;
import com.example.onlinealisveris.Adapter.PopularAdapter;
import com.example.onlinealisveris.Adapter.SliderAdapter;
import com.example.onlinealisveris.Domain.CategoryDomain;
import com.example.onlinealisveris.Domain.ItemsDomain;
import com.example.onlinealisveris.Domain.SliderItems;
import com.example.onlinealisveris.databinding.ActivityMainBinding;
        ...
        myref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    if(!items.isEmpty()){
                        binding.recylerviewPopular.setLayoutManager(new GridLayoutManager(MainActivity.this,2));
                        binding.recylerviewPopular.setAdapter(new PopularAdapter(items));
                    }
